...
public class MyOnProcessAdapter extends RecyclerView.Adapter<MyOnProcessAdapter.MyOrderHolder> {
    ...
    public void onBindViewHolder(@NonNull MyOrderHolder holder, int position) {
        ...
        deliverModel = deliverModelList.get(position);
        ...
        if (deliverModel.getName1() == null) {
            holder.txtN1.setVisibility(View.GONE);
        } else {
            holder.txtN1.setText(deliverModel.getName1());
        }
        if (deliverModel.getName2() == null) {
            holder.txtN2.setVisibility(View.GONE);
        } else {
            holder.txtN2.setText(deliverModel.getName2());
        }
        if (deliverModel.getName3() == null) {
            holder.txtN3.setVisibility(View.GONE);
        } else {
            holder.txtN3.setText(deliverModel.getName3());
        }
        if (deliverModel.getName4() == null) {
            holder.txtN4.setVisibility(View.GONE);
        } else {
            holder.txtN4.setText(deliverModel.getName4());
        }
        if (deliverModel.getName5() == null) {
            holder.txtN5.setVisibility(View.GONE);
        } else {
            holder.txtN5.setText(deliverModel.getName5());
        }
        if (deliverModel.getName6() == null) {
            holder.txtN6.setVisibility(View.GONE);
        } else {
            holder.txtN6.setText(deliverModel.getName6());
        }
        if (deliverModel.getName7() == null) {
            holder.txtN7.setVisibility(View.GONE);
        } else {
            holder.txtN7.setText(deliverModel.getName7());
        }
        if (deliverModel.getName8() == null) {
            holder.txtN8.setVisibility(View.GONE);
        } else {
            holder.txtN8.setText(deliverModel.getName8());
        }
        holder.txtAddress.setText(new StringBuilder("Address: ").append(deliverModel.getAddress()));
        holder.txtStat.setText(deliverModel.getStatus());
        holder.txtStat.setTextColor(Color.parseColor("#FFA500"));
        holder.txtTotalOrderP.setText(String.valueOf(deliverModel.getTotalPrice()));
        holder.txtIDNUM.setText(deliverModel.getKey());
        holder.txtPID.setText(deliverModel.getPID());
        holder.txtUID.setText(deliverModel.getUID());
        holder.customer.setText(deliverModel.getCustomer());
        ...
        holder.btnOFD.setOnClickListener(view -> {
